...
const ITEMS = [
  {
    ...
    a: "Avreya собирает связку «текст + визуал + бренд» в одном потоке. ChatGPT не умеет в обложки, Midjourney не знает твой прайс. Студия знает и то, и другое.",
  },
  {
    q: "Где берёт визуалы?",
  ...
  },
  {
    ...
    a: "Весь сгенерированный контент принадлежит тебе. Никаких водяных знаков avreya в публикациях нет.",
  },
  {
