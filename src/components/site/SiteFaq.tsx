...
const ITEMS = [
  {
    ...
    a: "В Tilda ты сам собираешь блоки. Здесь — рассказываешь о бизнесе, остальное делает avreya. Готовый сайт за 30 минут вместо 30 часов.",
  },
  {
  ...
  {
    q: "Кто хостит сайт?",
    a: "Серверы avreya в РФ. Сайт работает на нашей инфраструктуре, ты не платишь за хостинг отдельно. SLA 99.9% для тарифа Бизнес и выше.",
  },
  {
  ...
  },
  {
    ...
    a: "Да. Любой язык. Avreya понимает контекст и адаптирует тексты под рынок.",
  },
  {
    q: "Если нужна кастомизация дизайна сильнее, чем в редакторе?",
    a: "Тариф Студия даёт доступ к ручному коду секций. Или закажи ручную доработку у команды avreya — это отдельный сервис.",
  },
];
