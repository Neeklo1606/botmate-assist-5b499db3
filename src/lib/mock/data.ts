 ...
 * Только реальные тексты на русском, отражающие позиционирование avreya.
 */
...
export const first100Benefits: First100Benefit[] = [
  {
    ...
    description:
      "Команда avreya собирает ассистента под ваш бизнес. 40+ часов работы лида и продакта.",
    icon: "Wrench",
  },
  {
    id: "f2",
...
export const mockUser: User = {
  id: "u_demo",
  name: "Никита Клочко",
  username: "nikita_avreya",
  email: "nikita@avreya.studio",
  avatarInitials: "НК",
  workspaceName: "avreya studio",
  role: "owner",
  plan: "growth",
};
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    task: [
      "До avreya «Контур» терял до 40% входящих ночью и в выходные. Менеджеры просыпались в Telegram под 30 сообщений и физически не успевали отвечать всем — клиент уходил к конкуренту, который ответил первым.",
  ...
  },
  {
    ...
    quote: {
      text: "Раньше тратили на ФОТ Avito-менеджеров 720к. Сейчас 300к плюс avreya. Качество лидов выросло.",
  ...
  },
  {
    ...
    task: [
      "До avreya «Skill Up» имела сильный маркетинг, но слабый отдел продаж: менеджеры не успевали обрабатывать всех. Стоимость лида росла, а конверсия в оплату падала.",
    ...
    quote: {
      text: "Перестали драться за каждого лида — теперь у нас лидов больше, чем рук. Avreya — главный продавец компании.",
  ...
  },
  {
    ...
    quote: {
      text: "Раньше команда тонула в брифингах. Сейчас на встрече мы сразу обсуждаем стратегию — avreya сделал всю предварительную работу.",
      author: "Ренат Юсупов",
      role: "founder",
    },
...
export const scenarioDetails: Record<string, ScenarioDetail> = {
  ...
  other: {
    ...
    pain: "Не нашли свою нишу? Команда avreya соберёт ассистента под любой бизнес, от логистики до b2b SaaS.",
    tasks: [
...
export const teamPeople: TeamPerson[] = [
  {
    ...
    bio: "8 лет в продуктах для b2b. До avreya, продакт-директор в avreya.studio.",
    initials: "НК",
  },
  {
    id: "p2",
...
export const legalDocs: Record<"privacy" | "offer", LegalDocument> = {
  privacy: {
    ...
    intro:
      "Настоящая политика описывает, как ИП Клочко Никита Николаевич (далее — «Оператор», avreya) обрабатывает персональные данные пользователей сервиса avreya.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Доступ к данным имеет только пользователь и уполномоченные сотрудники avreya в объёме, необходимом для предоставления услуг.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Запросы направляйте на email: privacy@avreya.ru. Срок ответа — до 10 рабочих дней.",
        ],
      },
      {
  ...
  offer: {
    ...
    updatedAt: "2026-04-01",
    intro:
      "Настоящий документ является публичной офертой ИП Клочко Никита Николаевич (ИНН 7806123456) на заключение договора об оказании услуг сервиса avreya. Оплата услуг означает полное и безоговорочное принятие условий оферты.",
    sections: [
      {
        heading: "1. Предмет договора",
        paragraphs: [
          "Исполнитель предоставляет Заказчику доступ к сервису avreya — программному комплексу для создания и управления AI-ассистентами в мессенджерах и на сайтах.",
