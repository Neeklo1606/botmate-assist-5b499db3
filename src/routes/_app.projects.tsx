  ...
  return (
    <div className="space-y-5 text-foreground">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <Filter className="h-3.5 w-3.5" style={{ color: "var(--color-ink-subtle)" }} />
        {FILTERS.map((f) => {
          ...
          return (
            <button
              ...
              style={{
                background: active ? "color-mix(in oklab, var(--color-accent) 12%, transparent)" : "var(--color-surface-muted)",
