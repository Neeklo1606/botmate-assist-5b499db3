...
const STATIC_PATHS: Array<{ path: string; changefreq: string; priority: string }> = [
  ...
  { path: "/site", changefreq: "weekly", priority: "0.9" },
  { path: "/onboarding/assistant", changefreq: "monthly", priority: "0.7" },
  { path: "/onboarding/media", changefreq: "monthly", priority: "0.7" },
  { path: "/onboarding/site", changefreq: "monthly", priority: "0.7" },
